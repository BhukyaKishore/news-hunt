...
export default class News extends Component {
  ...
  async updatePage() {
    ...
    let url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&page=${this.state.pageNo}&apiKey=862860c0bc5444468229092957eef7e5&pagesize=${this.props.pagesize}`;
    ...
    console.log("total resultd are :" + parsedData.totalResults);
    this.setState({
      loding: false,
  ...
  fetchMoreData = async () => {
    ...
    let url = `https://newsapi.org/v2/top-headlines?country=${
      ...
      this.state.pageNo + 1
    }&apiKey=862860c0bc5444468229092957eef7e5&pagesize=${this.props.pagesize}`;
    ...
    return (
      <>
        <div className="row container-fluid mx-auto text-center ">
          <h1 className="text-white text-center mt-5 pt-5">
          ...
          >
            {this.state.articles.map((element) => {
              return (
                <>
                  <div
                    className="col-sm-6 col-xs-12 col-md-4 col-lg-3 d-flex container justify-content-center pt-2"
                    key={element.url}
                  >
                    <NewsItem
                      title={
